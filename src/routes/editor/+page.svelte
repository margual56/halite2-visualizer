...
<div class="flex h-screen flex-col bg-gray-950 text-white">
	...
	<main class="flex min-h-0 flex-1">
		<!-- Sidebar -->
		<aside
			class="flex w-80 shrink-0 flex-col gap-4 overflow-y-auto border-r border-white/10 p-4 text-sm"
		>
			...
			<div class="rounded-lg border border-amber-400/20 bg-amber-400/5 p-3 text-xs">
				<p class="leading-relaxed text-amber-200/80">
					<strong class="text-amber-200">Bots run locally, not in the browser.</strong> The visualizer
					can't execute Python — when you're done editing, download the file and run it with the engine
					on your machine.
				</p>
			</div>
